...
/**
 * Classe responsável por centralizar toda a configuração de segurança da API.
 */
@Configuration
@EnableWebSecurity
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    // Habilitando acesso do H2-DATABASE na WEB.
    @Bean
    public ServletRegistrationBean<WebdavServlet> h2servletRegistration() {
